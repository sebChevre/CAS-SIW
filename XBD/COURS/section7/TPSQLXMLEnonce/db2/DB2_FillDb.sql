...
-- Création des tables
create table Villes (
	IdVille int primary key not null,
	NPA int not null,
	Nom varchar(100) not null);

create table Radios (
	IdRadio int primary key not null,
	Nom varchar(50) not null,
	Genre varchar (100));

create table Frequences (
	IdFreq int primary key not null,
	IdVille int not null,
	IdRadio int not null,
	Frequence decimal(10,2) not null,
	constraint FK1 foreign key (IdVille) references SCETEST.Villes(IdVille),
	constraint FK2 foreign key (IdRadio) references SCETEST.Radios(IdRadio));
